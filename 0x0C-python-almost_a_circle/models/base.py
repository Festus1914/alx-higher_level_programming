...
class Base:
    ''' This actually represent the base for all
    class
    ...
    def to_json_string(list_dictionaries):
        '''Return the Json serialization of a list in a dicts.
    ...
    def save_to_file(cls, list_objs):
        '''Write the Json serialization of a list in a dicts.
    ...
    def create(cls, **dictionary):
        '''Return a class instantied from a dictionary of an attributes.

        Args:
        **dictionary: key/value pairs of the attribute initialize.
        '''
